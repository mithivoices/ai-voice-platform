        ...
        <div className="flex w-full flex-1 flex-col justify-center items-center bg-white p-6 lg:w-[60%] lg:px-20 xl:px-32">
          <div className="w-full max-w-[400px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              <h1 className="text-3xl font-bold tracking-tight text-slate-900 lg:text-4xl">Create an account</h1>
              <p className="text-slate-500 text-base">Start your journey with Mithivoices today.</p>
            </div>
            {/* Form */}
            <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
              {/* Name Field */}
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium leading-none text-slate-900" htmlFor="name">Full Name</label>
                <input 
              ...
              <div className="flex items-start gap-2">
                <input className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary mt-0.5" type="checkbox"/>
        ...
        <div className="hidden lg:flex w-[40%] flex-col relative overflow-hidden text-white bg-linear-to-br from-primary to-blue-800">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-12">
            ...
            <div className="flex-1 flex items-center justify-center py-10">
              <div className="relative w-full aspect-square max-w-[400px]">
                <div className="absolute inset-0 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl p-6 flex flex-col gap-4 transform rotate-2 transition-transform duration-700 hover:rotate-0">
                  ...
                  <div className="flex items-center justify-center gap-1 h-32 w-full mt-4">
                    {[30, 50, 80, 40, 60, 90, 45, 70, 35, 55, 85, 40, 65, 30].map((height, i) => (
                      <div key={i} className="w-2 bg-white/60 rounded-full" style={{ height: `${height}%` }}></div>
                    ))}
                  </div>
                  {/* Play button */}
                  ...
                  {/* Floating Badge */}
                  <div className="absolute -left-4 -bottom-4 bg-primary text-white p-3 rounded-xl shadow-lg flex items-center gap-2 text-xs font-bold">
            ...
            <div className="flex flex-col gap-6">
              <h2 className="text-3xl font-bold leading-tight">Start creating today</h2>
              <ul className="space-y-4 text-lg text-purple-100">
          ...
          <div className="absolute -bottom-1/2 -right-1/2 h-full w-full rounded-full bg-primary/30 blur-3xl filter mix-blend-overlay"></div>
